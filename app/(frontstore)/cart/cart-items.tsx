...
export default function CartItems() {
    const { items, isOpen, open, close, changeQty, remove, reset } = useCartStore((state) => state)
    ...
    return (
        <div className="gap-6 flex flex-col md:flex-row md:items-start">
            ...
            {items.length !== 0 &&
                <div className="w-full flex-1">
                    <div className="w-full flex items-center justify-between pb-4 border-b border-dashed">
                        <h2 className="text-lg font-bold">Articles du panier</h2>
            ...
            <div className="w-full lg:w-100 sticky bottom-0 md:top-0 right-0 bg-white py-2">

                <h2 className="text-lg font-bold pb-2 md:pb-7 border-b border-dashed">Résume</h2>
