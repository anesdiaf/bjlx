...
import { providerFromSchema } from "@/types";
...
export default function ProviderForm() {
    ...
    return (
        <Dialog open={open}>
            <DialogTrigger onClick={() => setOpen(true)} render={<Button><PlusIcon className="block md:hidden" /><span className="hidden md:block">Nouvel expéditeur</span></Button>} />
