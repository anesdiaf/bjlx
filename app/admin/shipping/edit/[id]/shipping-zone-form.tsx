...
import { providerFromSchema, shippingProviderWithZonesType, shippingZoneFromSchema } from "@/types";
...
export default function ShppingZoneForm({ id }: { id: number }) {
    ...
    return (
        <Dialog open={open}>
            <DialogTrigger onClick={() => setOpen(true)} render={<Button><PlusIcon /></Button>} />
            <DialogContent showCloseButton={false}>
                <DialogHeader>
                    <DialogTitle className="w-full flex justify-between items-center">Nouvelle zone d'expédition
